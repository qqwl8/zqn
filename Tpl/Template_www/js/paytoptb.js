var login_name='';
var pay_info = {gid:0,sid:0,pay_user:'',pay_tag:0,pay_way:'',pay_bank:'',cardpay_rate:0,pay_money:100,exchange_rate:0,pay_got_gold:0,orderid:0};
...
function select_game(gid,exchange_rate){
	//保存数据
		...
		document.getElementById("game_id").value=gid;
}
...
function select_server(sid){
	...
	pay_info.sid = sid;
	document.getElementById("server_id").value=sid;
	//选中服
