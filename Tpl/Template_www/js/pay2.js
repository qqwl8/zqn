...
select_pay_way('weixinnew', '支付宝(余额)', '100');
function fullbg() {
    $("#fullbg").show();
}
function fullbghide() {
...
if (Query_username != '') {
    ...
    if (login_name != '' && login_name != Query_username) $('#check_username_msg').text('与当前登陆账号不一致');
}
//展开选择游戏
